...
func registerReminderRoutes(v1 *gin.RouterGroup, auth gin.HandlerFunc, h *handler.CareReminderHandler, limiter *middleware.RateLimiter) {
	reminders := v1.Group("/reminders", auth)
